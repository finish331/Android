...
public class FriendsContentProvider extends ContentProvider {
    ...
    private static final String AUTHORITY =
            "com.a105590030.user.myapplication.providers.FriendsContentProvider";
    ...
    public int delete(Uri uri, String  selection, String[]  selectionArgs) {
        ...
        int mRowsDeleted = mFriendDb.delete(DB_TABLE, "name="+"\""+selection+"\"", null);
        return mRowsDeleted;
    }
    ...
    public int update(Uri uri, ContentValues contentValues, String selection,
        ...
        int mRowsUpdated = mFriendDb.update(DB_TABLE, contentValues, "name="+"\""+selection+"\"", null);
        return mRowsUpdated;
    }
}
